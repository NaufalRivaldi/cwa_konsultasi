    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <form action="<?= site_url('backend/colorcard/addfast') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label>Gambar</label>
              <input type="file" name="gambar[]" multiple="multiple" class="form-control <?= form_error('gambar') ? 'is-invalid' : '' ?>">
              <div class="invalid-feedback">
                <?= form_error('gambar') ?>
              </div>
              <p class="text-danger">*Max upload 20 Foto</p>
            </div>
